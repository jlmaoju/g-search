...
红白版网页前端现已收录在 [`frontend/`](frontend/README.md)，包括干净的欢迎首屏、内容 / 标题 / 时间轴三选一、完整筛选、GitHub 入口及后端离线、超时、API 额度不足等状态提示。该目录提供独立的开发、测试和构建命令；现有本地搜索页仍可按下方步骤启动。

本次还同步了完整参与者列表、关键词筛选、缓存更新、请求取消和封面代理等功能修复。后端及原前端的回归测试见 [`tests/`](tests/README.md)。
...
- 数据包下载链接：[百度网盘](https://pan.baidu.com/s/12rMddY5DDQLxZM22KY_6Ng?pwd=1111)，提取码：`1111`。
...
[百度网盘下载 gsearch-data-release-2026-04-29.tar.gz](https://pan.baidu.com/s/12rMddY5DDQLxZM22KY_6Ng?pwd=1111)
